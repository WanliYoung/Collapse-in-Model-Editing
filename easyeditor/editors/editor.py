...
def compute_ppl(predictions, model, tokenizer, batch_size: int = 16, add_start_token: bool = True, device=None, max_length=None):
    # if batch_size > 1 (which generally leads to padding being required), and
    # if there is not an already assigned pad_token, assign an existing
    # special token to also be the padding token
    if tokenizer.pad_token is None and batch_size > 1:  # Not go
    ...
    if add_start_token and max_length:  # Not go
...
class BaseEditor:
    ...
    def __init__(self,
        ...
        if type(self.model_name) is str:
            ...
            self.ppl_tok = deepcopy(self.tok)
    ...
    def edit(self,
        ...
        # load ppl texts
        ppl_data_path = None
        if self.hparams.ppl_sentence_num == 50:
            ppl_data_path = "./data/ME-PPL/ME-PPL_50.json"
        elif self.hparams.ppl_sentence_num == 1000:
            ppl_data_path = "./data/ME-PPL/ME-PPL_1k.json"
        elif self.hparams.ppl_sentence_num == 10000:
            ppl_data_path = "./data/ME-PPL/ME-PPL.json"
